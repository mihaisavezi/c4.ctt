...
let listItems = '';
issues
    .map(res => listItems += `<li class="f6 f5-ns b dib ph5 pv4 mr3 mb3 hover-black hover-bg-white bg-animate no-underline white ba br-pill b--white-40 fw4">${res.issue}</li>`);
